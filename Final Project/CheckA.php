...
<div class="entries">
        ...
        echo "<h1 align='center'>Appointments</h1>";

        if ($result) {
            echo "<table class='doctor-table'>";
            echo "<tr><th>Appointment ID</th><th>User ID</th><th>Doctor ID</th><th>Service ID</th><th>Date</th><th>Time</th><th>Service Fee</th></tr>";

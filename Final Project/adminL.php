<?php
        if (isset($_POST["submit"])) {
            if (!empty($_POST['admin']) && !empty($_POST['pass'])) {
                ...
                $query = mysqli_prepare($con, "SELECT * FROM Admin WHERE Name=? AND Password=?");
        ...
        <div class="container">
            ...
            <form action="adminL.php" method="POST">
                <div class="input-field">
                    <input type="text" class="input" name="admin" required>
                ...
                <h1>Go to home page <a href="index.html"> click here! </a></h1>
            </form>

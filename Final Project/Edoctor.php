...
<div class="entries">
        ...
        <form name="editForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"
            ...
            <table border=0 cellpadding=5 align="center">
                ...
                <tr>
                    <td>New Expertise :</td>
                    <td><input type="text" name="new_exp" size="30"></td>
                </tr>
                <tr>
                    <td>New Date :</td>
                    <td><input type="text" name="new_d" size="30"></td>
                </tr>
                <tr>
                    <td>New Hour :</td>
                    <td><input type="text" name="new_h" size="30"></td>
                </tr>
                <tr>
    ...
    if (isset($_POST['submit'])) {
        ...
        $new_date = $_POST['new_d'];
        $new_hour = $_POST["new_h"];

        if (empty($doctor_id) ||empty($new_name) || empty($new_exp) || empty($new_date) || empty($new_hour)) {
            echo '<div class="error-message"><h3><b>You didn\'t fill up the form correctly!</b></h3></div>';
        } else {
            $update_query = "UPDATE doctor SET name = '$new_name', expertise = '$new_exp', available_date = '$new_date', available_hour = '$new_hour'";

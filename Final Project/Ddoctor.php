...
<?php
        ...
        if (isset($_GET['delete_id'])) {
            ...
            if ($result) {
                ...
                echo "<p align='center'>Failed to delete.</p>";
            }
        }
        ...
        echo "<h1 align='center'>Remove Doctors</h1>";

        if ($result) {
            echo "<table class='service-table'>";
            echo "<tr><th>Doctor ID</th><th>Name</th><th>Expertise</th><th>Available Date</th><th>Available Hour</th><th>Action</th></tr>";
            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                ...
                echo "<td>".$ava."</td>";
                echo "<td>".$avh."</td>";
                echo "<td><a class='delete-link' href='Ddoctor.php?delete_id=".$id."' onclick='return confirm(\"Are you sure you want to delete this service?\");'>Delete</a></td>";
                echo "</tr>";
            }
            echo "</table>";
        } else {
